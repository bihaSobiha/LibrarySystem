...
public class SubClassificationController extends HttpServlet {
    ...
    SubClassificationDetails scd = new SubClassificationDetails();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("./pages/SubClassification.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //processRequest(request, response);
        scd.setScId(request.getParameter("Scid"));
        scd.setMcId(request.getParameter("Mcid"));
        scd.setScName(request.getParameter("Scname"));

        try {
            ScDao.addsubclassification(scd);
